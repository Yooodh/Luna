...
<body>
    ...
    <article id="content">
        <section>
            <img id="mainimg" src="/image/wed_p_8.jpg" alt="main img" width="1500">
        </section>

        <section class="visual">
        <br />
            <p id="title1">신부대기실</p><br>
            <h1 id="title2"> Bride Room </h1><br><br><br>

            <div class="slideshow-container">
                <!-- Full-width images with number and caption text -->
                <div class="mySlides fade">
                    <div class="numbertext">1 / 6</div>
                    <img src="/image/wed_b_6.jpg" style="width:100%">
                </div>

                <div class="mySlides fade">
                    <div class="numbertext">2 / 6</div>
                    <img src="/image/wed_b_7.png" style="width:100%">
                </div>

                <div class="mySlides fade">
                    <div class="numbertext">3 / 6</div>
                    <img src="/image/wed_b_8.jpg" style="width:100%">
                </div>

                <div class="mySlides fade">
                    <div class="numbertext">4 / 6</div>
                    <img src="/image/wed_p_6.jpg" style="width:100%">
                </div>

                <div class="mySlides fade">
                    <div class="numbertext">5 / 6</div>
                    <img src="/image/wed_p_7.jpg" style="width:100%">
                </div>

                <div class="mySlides fade">
                    <div class="numbertext">6 / 6</div>
                    <img src="/image/wed_p_8.jpg" style="width:100%">
                </div>
            ...
            <li id="promote2">
                <h1>오직 신부님만을 위한 공간,<br>
                    편안하고 품격있는 신부대기실</h1><br>

                <p>존귀하고 우아한 귀하를 위한 아름다운 웨딩을 연출합니다.</p><br>

                <p>≪Description≫</p><br>

                <p>오직 신부님만을 돋보이는게 하는 신부대기실은 설레이는 순간을 편안한 마음으로 기다릴수 있는 공간입니다.<br>
                    진정한 하우스 & 채플컨셉의 품격있는 웨딩을 연출합니다.<br>
                    그날의 주인공인 신부님의 아름다운 자태를 더욱 빛나게해드립니다.</p><br>
